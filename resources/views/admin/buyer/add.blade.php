                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    value="{{ old('company_number', isset($buyer) ? $buyer->company_number : '') }}" maxlength="10" placeholder="Enter Company Number">
                        ...
                        <div class="row mt-3">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    value="{{ old('contact_person_name', isset($buyer) ? $buyer->contact_person_name : '') }}" placeholder="Enter Person Name">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    value="{{ old('contact_person_mobile_number', isset($buyer) ? $buyer->contact_person_mobile_number : '') }}" maxlength="10" placeholder="Enter Contact Person Mobile Number">

            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.category.store') }}" name="addfrm" id="addfrm" method="POST"
                            ...
                            <div class="col-6 col-md-6 col-sm-12">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="brand_id" id="brand_id">
                                        ...
                                        <option value="{{ $category->brand_id }}" selected>
                                            {{ $category->brand->brand_name }}</option>
                                    </select>
                                    @error('brand_id')
                        ...
                        @php
                            $icon = isset($category->category_icon) && $category->category_icon != '' && \File::exists(public_path('uploads/category/' . $category->category_icon)) ? asset('uploads/category/' . $category->category_icon) : '';
                        @endphp
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control dropify {{ $iconExits }}" name="category_icon"
                                id="category_icon" data-default-file="{{ $icon }}"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="remark" class="form-control" id="remark">{{ $category->remark }}</textarea>
                            @error('remark')
                                <span class="text text-danger" role="alert">
                                    {{ $message }}
                                </span>
        ...
        $(document).ready(function() {
            $("#addfrm").validate({
                ...
                rules: {
                    ...
                    category_icon: {
                        required: function() {
                            return ($("#category_icon").val() == "" && $("#previewpicimg").attr(
                                'src') == "");
                        }
                    },
                },
